//Array source file implements the Array class defined in 
...
namespace JoseAponte
{
	namespace Containers
	{
		...
		template<typename T>
		Array<T>::Array() : arr_size(def_size), m_data(new T[arr_size]) {}					//Default constructor that allocates 10 elements w/ Colon Syntax
