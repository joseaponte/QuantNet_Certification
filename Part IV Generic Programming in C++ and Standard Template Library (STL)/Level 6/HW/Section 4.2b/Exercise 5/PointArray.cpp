//PointArray source file implements the PointArray class 
...
namespace JoseAponte
{
	namespace Containers
	{
		...
		double PointArray::Length()													//Add a Length() function that returns the total length between the points in the array
		{
