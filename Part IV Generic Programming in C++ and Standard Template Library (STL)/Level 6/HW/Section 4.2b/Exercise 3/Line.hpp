//Line.hpp is the header file for the The Line class, 
//which has a start - and an end - point such that it 
//has two Point objects as data members
...
namespace JoseAponte
{
	namespace CAD
	{
		...
		public:
			...
			void Draw() const;					//Line Draw () function that simulates drawing by just printing some text
		};
	}
}
#endif