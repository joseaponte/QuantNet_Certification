//Stack.cpp implements the stack class defined in the 
//stack header file
...
namespace JoseAponte
{
	namespace Containers
	{
		...
		template <typename T>
		int Stack<T>::Current() const								//Current() function is a getter that returns the current element numeber (index + 1)(makes it easier to test in main)
		{
			return m_current + 1;
		}
