//Point.hpp is the header file for the Point class 
// with private members for the x- and y-coordinates.
...
namespace JoseAponte
{
	namespace CAD {
		...
		public:
			...
			void Draw() const;							//Point Draw () function that simulates drawing by just printing some text
		};
