//Circle.hpp is the header file for the circle class, 
//which has a center point and a radius as private data members
...
namespace JoseAponte
{
	namespace CAD
	{
		...
		public:
			...
			Circle(Point& P, Line& L);		//Constructor that accepts a line and a point as parameters
