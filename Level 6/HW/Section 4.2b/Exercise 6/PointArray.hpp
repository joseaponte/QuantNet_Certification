//PointArray.hpp is the header file for the Point Array class, which will be derived form the Array class
...
namespace JoseAponte {
	namespace Containers {
		...
		public:
			...
			double Length() const;								//Add a Length() function that returns the total length between the points in the array
		};
	}
}
