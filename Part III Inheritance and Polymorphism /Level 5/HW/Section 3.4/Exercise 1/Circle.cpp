...
namespace JoseAponte
{
	namespace CAD
	{
		Circle::Circle(const Point& P, const Line& L) :center(P), radius(L) {}			//Constructor that accepts a line and a point as parameters w/ Colon Syntax

		Circle::Circle(const Circle& C) : center(C.center), radius(C.radius) {}			//Copy constructor w/ Colon Syntax
