...
namespace JoseAponte
{
	namespace CAD
	{
		Line::Line(const Point& P1, const Point& P2) : start_p(P1), end_p(P2) {}	//Line Constructor that accepts a start & end point w/ Colon Syntax

		Line::Line(const Line& L) : start_p(L.start_p), end_p(L.end_p) {} 			//Copy constructor w/ Colon Syntax
